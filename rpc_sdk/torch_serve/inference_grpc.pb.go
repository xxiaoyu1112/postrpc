...
type InferenceAPIsServiceClient interface {
	Ping(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*TorchServeHealthResponse, error)
...
func (c *inferenceAPIsServiceClient) Ping(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*TorchServeHealthResponse, error) {
...
type InferenceAPIsServiceServer interface {
	Ping(context.Context, *empty.Empty) (*TorchServeHealthResponse, error)
	// Predictions entry point to get inference using default model version.
...
func (UnimplementedInferenceAPIsServiceServer) Ping(context.Context, *empty.Empty) (*TorchServeHealthResponse, error) {
...
func _InferenceAPIsService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InferenceAPIsServiceServer).Ping(ctx, req.(*empty.Empty))
	}
